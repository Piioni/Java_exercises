...
public class CasaRural extends Casa{
    ...
    public CasaRural(int identificador, int area , String direccion, int numHabitaciones, int numBanos, int numPisos, double valorArea, int distanciaCabecera, int latitud){
